...
import com.gafahtec.consultorio.dto.response.ApiResponse;
...
//	}
	@PostMapping
	public ApiResponse<Usuario> registrar(@RequestBody UsuarioRequest usuarioRequest) throws Exception {
		URI location = null;
...
//		return ResponseEntity.created(location).build();
		return new ApiResponse<>(HttpStatus.OK.value(), "Se grabo correctamente", obj);
	}
