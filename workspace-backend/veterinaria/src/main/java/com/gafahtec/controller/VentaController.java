...
//		System.out.println("3");
	...
	@PostMapping
	public ResponseEntity<Venta> registrar(@Valid @RequestBody Venta p, Authentication authentication) throws Exception{
//		System.out.println("1====>>> "+ p);
	...
	@PutMapping
	public ResponseEntity<Venta> modificar(@Valid @RequestBody Venta p, Authentication authentication) throws Exception{
