...
public class EmpleadoController {
	...
	@PostMapping
	public ResponseEntity<Empleado> registrar(@Valid @RequestBody Empleado p, Authentication authentication)
			throws Exception {
	...
	@PutMapping
	public ResponseEntity<Empleado> modificar(@Valid @RequestBody Empleado p, Authentication authentication)
			throws Exception {
	...
	@GetMapping("/pageable")
	public ResponseEntity<Page<Empleado>> listarPageable(@PageableDefault(sort = "apellidoPaterno") Pageable pageable)
			throws Exception {
