...
//	@GetMapping("/{idTipoMascota}")
	...
	@PostMapping
	public ResponseEntity<Raza> registrar(@Valid @RequestBody Raza p, Authentication authentication) throws Exception{
	...
	@PutMapping
	public ResponseEntity<Raza> modificar(@Valid @RequestBody Raza p, Authentication authentication) throws Exception{
//		System.out.println(p);
