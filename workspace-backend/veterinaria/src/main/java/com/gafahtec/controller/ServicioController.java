...
public class ServicioController {
	...
	@PostMapping
	public ResponseEntity<Servicio> registrar(@Valid @RequestBody Servicio p, Authentication authentication) throws Exception{
	...
	@PutMapping
	public ResponseEntity<Servicio> modificar(@Valid @RequestBody Servicio p, Authentication authentication) throws Exception{
